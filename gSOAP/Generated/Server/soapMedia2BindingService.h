...
#include "soapH.h"
    ...
    class SOAP_CMAC Media2BindingService {
      public:
        ...
        virtual int SetEQPreset(_tr2__SetEQPresetConfiguration *tr2__SetEQPresetConfiguration, tr2__SetConfigurationResponse &tr2__SetEQPresetConfigurationResponse) SOAP_PURE_VIRTUAL;
        //
        ...
        virtual int GetWebRTCConfigurations(_tr2__GetWebRTCConfigurations *tr2__GetWebRTCConfigurations, _tr2__GetWebRTCConfigurationsResponse &tr2__GetWebRTCConfigurationsResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'SetWebRTCConfigurations' implementation, should return SOAP_OK or error code
        virtual int SetWebRTCConfigurations(_tr2__SetWebRTCConfigurations *tr2__SetWebRTCConfigurations, _tr2__SetWebRTCConfigurationsResponse &tr2__SetWebRTCConfigurationsResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'GetAudioClips' implementation, should return SOAP_OK or error code
        virtual int GetAudioClips(_tr2__GetAudioClips *tr2__GetAudioClips, _tr2__GetAudioClipsResponse &tr2__GetAudioClipsResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'AddAudioClip' implementation, should return SOAP_OK or error code
        virtual int AddAudioClip(_tr2__AddAudioClip *tr2__AddAudioClip, _tr2__AddAudioClipResponse &tr2__AddAudioClipResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'SetAudioClip' implementation, should return SOAP_OK or error code
        virtual int SetAudioClip(_tr2__SetAudioClip *tr2__SetAudioClip, _tr2__SetAudioClipResponse &tr2__SetAudioClipResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'DeleteAudioClip' implementation, should return SOAP_OK or error code
        virtual int DeleteAudioClip(_tr2__DeleteAudioClip *tr2__DeleteAudioClip, _tr2__DeleteAudioClipResponse &tr2__DeleteAudioClipResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'PlayAudioClip' implementation, should return SOAP_OK or error code
        virtual int PlayAudioClip(_tr2__PlayAudioClip *tr2__PlayAudioClip, _tr2__PlayAudioClipResponse &tr2__PlayAudioClipResponse) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'GetPlayingAudioClips' implementation, should return SOAP_OK or error code
        virtual int GetPlayingAudioClips(_tr2__GetPlayingAudioClips *tr2__GetPlayingAudioClips, _tr2__GetPlayingAudioClipsResponse &tr2__GetPlayingAudioClipsResponse) SOAP_PURE_VIRTUAL;
    };
#endif
