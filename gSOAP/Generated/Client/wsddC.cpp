...
SOAP_SOURCE_STAMP("@(#) wsddC.cpp ver 2.8.139 2025-09-09 07:11:27 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_SOAP_ENV__Fault_wsa5:
		return soap_in_SOAP_ENV__Fault_wsa5(soap, tag, NULL, "SOAP-ENV:Fault-wsa5");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		if (!soap_match_tag(soap, t, "SOAP-ENV:Fault-wsa5"))
		{	*type = SOAP_TYPE_SOAP_ENV__Fault_wsa5;
			return soap_in_SOAP_ENV__Fault_wsa5(soap, tag, NULL, NULL);
		}
...
{	(void)tag;
	...
	case SOAP_TYPE_SOAP_ENV__Fault_wsa5:
		return soap_out_SOAP_ENV__Fault_wsa5(soap, tag, id, (const struct SOAP_ENV__Fault_wsa5 *)ptr, "SOAP-ENV:Fault-wsa5");
	case SOAP_TYPE_chan__ChannelInstanceType:
	...
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_putelement '%s' failed for type %d in /home/wensn/Project/Onvif/gSOAP/Generated/Client/wsddC.cpp\n", tag ? tag : "", type));
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_wsdd__HelloType:
		...
		break;
	case SOAP_TYPE_SOAP_ENV__Fault_wsa5:
		soap_serialize_SOAP_ENV__Fault_wsa5(soap, (const struct SOAP_ENV__Fault_wsa5 *)ptr);
		break;
	case SOAP_TYPE_chan__ChannelInstanceType:
...
#endif
	case SOAP_TYPE_SOAP_ENV__Fault_wsa5:
		return (void*)wsdd_instantiate_SOAP_ENV__Fault_wsa5(soap, -1, type, arrayType, n);
	case SOAP_TYPE_wsdd__HelloType:
...
SOAP_FMAC3 int SOAP_FMAC4 wsdd_fdelete(struct soap *soap, struct soap_clist *p)
{
	...
	case SOAP_TYPE_SOAP_ENV__Fault_wsa5:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct SOAP_ENV__Fault_wsa5*>(p->ptr), struct SOAP_ENV__Fault_wsa5);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct SOAP_ENV__Fault_wsa5*>(p->ptr), struct SOAP_ENV__Fault_wsa5);
		break;
	case SOAP_TYPE_wsdd__HelloType:
		if (p->size < 0)
...
#endif
	case SOAP_TYPE_SOAP_ENV__Fault_wsa5:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct SOAP_ENV__Fault_wsa5 type=%d location=%p object=%p\n", t, p, q));
		*(struct SOAP_ENV__Fault_wsa5*)p = *(struct SOAP_ENV__Fault_wsa5*)q;
		break;
	case SOAP_TYPE_wsdd__HelloType:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_SOAP_ENV__Fault_wsa5(struct soap *soap, struct SOAP_ENV__Fault_wsa5 *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default__QName(soap, &a->faultcode);
	soap_default_string(soap, &a->faultstring);
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_SOAP_ENV__Fault_wsa5(struct soap *soap, const struct SOAP_ENV__Fault_wsa5 *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize__QName(soap, (char*const*)&a->faultcode);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_SOAP_ENV__Fault_wsa5(struct soap *soap, const char *tag, int id, const struct SOAP_ENV__Fault_wsa5 *a, const char *type)
{
	const char *soap_tmp_faultcode;
	soap_tmp_faultcode = soap_QName2s(soap, a->faultcode);
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_SOAP_ENV__Fault_wsa5), type))
		return soap->error;
	if (soap_out__QName(soap, "faultcode", -1, (char*const*)(void*)&soap_tmp_faultcode, ""))
		return soap->error;
	if (soap_out_string(soap, "faultstring", -1, (char*const*)&a->faultstring, ""))
...
SOAP_FMAC3 struct SOAP_ENV__Fault_wsa5 * SOAP_FMAC4 soap_in_SOAP_ENV__Fault_wsa5(struct soap *soap, const char *tag, struct SOAP_ENV__Fault_wsa5 *a, const char *type)
{
	size_t soap_flag_faultcode = 1;
	size_t soap_flag_faultstring = 1;
	size_t soap_flag_faultactor = 1;
	...
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	(void)type; /* appease -Wall -Werror */
	a = (struct SOAP_ENV__Fault_wsa5*)soap_id_enter(soap, soap->id, a, SOAP_TYPE_SOAP_ENV__Fault_wsa5, sizeof(struct SOAP_ENV__Fault_wsa5), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_SOAP_ENV__Fault_wsa5(soap, a);
	if (soap->body && *soap->href != '#')
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct SOAP_ENV__Fault_wsa5 *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_SOAP_ENV__Fault_wsa5, SOAP_TYPE_SOAP_ENV__Fault_wsa5, sizeof(struct SOAP_ENV__Fault_wsa5), 0, wsdd_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct SOAP_ENV__Fault_wsa5 * SOAP_FMAC2 wsdd_instantiate_SOAP_ENV__Fault_wsa5(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "wsdd_instantiate_SOAP_ENV__Fault_wsa5(%p, %d, %s, %s)\n", (void*)soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct SOAP_ENV__Fault_wsa5 *p;
	size_t k = sizeof(struct SOAP_ENV__Fault_wsa5);
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE_SOAP_ENV__Fault_wsa5, n, wsdd_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct SOAP_ENV__Fault_wsa5);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct SOAP_ENV__Fault_wsa5, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct SOAP_ENV__Fault_wsa5 location=%p n=%d\n", (void*)p, n));
	if (size)
		*size = k;
	if (!p)
		soap->error = SOAP_EOM;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_SOAP_ENV__Fault_wsa5(struct soap *soap, const struct SOAP_ENV__Fault_wsa5 *a, const char *tag, const char *type)
{
	if (soap_out_SOAP_ENV__Fault_wsa5(soap, tag ? tag : "SOAP-ENV:Fault-wsa5", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct SOAP_ENV__Fault_wsa5 * SOAP_FMAC4 soap_get_SOAP_ENV__Fault_wsa5(struct soap *soap, struct SOAP_ENV__Fault_wsa5 *p, const char *tag, const char *type)
{
	if ((p = soap_in_SOAP_ENV__Fault_wsa5(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
