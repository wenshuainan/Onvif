...
#ifndef SOAP_TYPE_SOAP_ENV__Fault_wsa5_DEFINED
#define SOAP_TYPE_SOAP_ENV__Fault_wsa5_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_SOAP_ENV__Fault_wsa5(struct soap*, struct SOAP_ENV__Fault_wsa5 *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_SOAP_ENV__Fault_wsa5(struct soap*, const struct SOAP_ENV__Fault_wsa5 *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_SOAP_ENV__Fault_wsa5(struct soap*, const char*, int, const struct SOAP_ENV__Fault_wsa5 *, const char*);
SOAP_FMAC3 struct SOAP_ENV__Fault_wsa5 * SOAP_FMAC4 soap_in_SOAP_ENV__Fault_wsa5(struct soap*, const char*, struct SOAP_ENV__Fault_wsa5 *, const char*);
SOAP_FMAC1 struct SOAP_ENV__Fault_wsa5 * SOAP_FMAC2 wsdd_instantiate_SOAP_ENV__Fault_wsa5(struct soap*, int, const char*, const char*, size_t*);

inline struct SOAP_ENV__Fault_wsa5 * soap_new_SOAP_ENV__Fault_wsa5(struct soap *soap, int n = -1)
{
	return wsdd_instantiate_SOAP_ENV__Fault_wsa5(soap, n, NULL, NULL, NULL);
}

inline struct SOAP_ENV__Fault_wsa5 * soap_new_req_SOAP_ENV__Fault_wsa5(
	struct soap *soap)
{
	struct SOAP_ENV__Fault_wsa5 *_p = ::soap_new_SOAP_ENV__Fault_wsa5(soap);
	if (_p)
	{	::soap_default_SOAP_ENV__Fault_wsa5(soap, _p);
	}
	return _p;
}

inline struct SOAP_ENV__Fault_wsa5 * soap_new_set_SOAP_ENV__Fault_wsa5(
	struct soap *soap,
	char *faultcode,
	char *faultstring,
	char *faultactor,
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_SOAP_ENV__Fault_wsa5(struct soap*, const struct SOAP_ENV__Fault_wsa5 *, const char*, const char*);

inline int soap_write_SOAP_ENV__Fault_wsa5(struct soap *soap, struct SOAP_ENV__Fault_wsa5 const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_SOAP_ENV__Fault_wsa5(soap, p), 0) || ::soap_put_SOAP_ENV__Fault_wsa5(soap, p, "SOAP-ENV:Fault-wsa5", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_SOAP_ENV__Fault_wsa5(struct soap *soap, const char *URL, struct SOAP_ENV__Fault_wsa5 const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_SOAP_ENV__Fault_wsa5(soap, p), 0) || ::soap_put_SOAP_ENV__Fault_wsa5(soap, p, "SOAP-ENV:Fault-wsa5", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_PATCH_SOAP_ENV__Fault_wsa5(struct soap *soap, const char *URL, struct SOAP_ENV__Fault_wsa5 const*p)
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_SOAP_ENV__Fault_wsa5(soap, p), 0) || ::soap_put_SOAP_ENV__Fault_wsa5(soap, p, "SOAP-ENV:Fault-wsa5", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_SOAP_ENV__Fault_wsa5(struct soap *soap, const char *URL, struct SOAP_ENV__Fault_wsa5 const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_SOAP_ENV__Fault_wsa5(soap, p), 0) || ::soap_put_SOAP_ENV__Fault_wsa5(soap, p, "SOAP-ENV:Fault-wsa5", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
SOAP_FMAC3 struct SOAP_ENV__Fault_wsa5 * SOAP_FMAC4 soap_get_SOAP_ENV__Fault_wsa5(struct soap*, struct SOAP_ENV__Fault_wsa5 *, const char*, const char*);

inline int soap_read_SOAP_ENV__Fault_wsa5(struct soap *soap, struct SOAP_ENV__Fault_wsa5 *p)
{
	if (p)
	{	::soap_default_SOAP_ENV__Fault_wsa5(soap, p);
		if (soap_begin_recv(soap) || ::soap_get_SOAP_ENV__Fault_wsa5(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_SOAP_ENV__Fault_wsa5(struct soap *soap, const char *URL, struct SOAP_ENV__Fault_wsa5 *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_SOAP_ENV__Fault_wsa5(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}

inline int soap_POST_recv_SOAP_ENV__Fault_wsa5(struct soap *soap, struct SOAP_ENV__Fault_wsa5 *p)
{
	if (::soap_read_SOAP_ENV__Fault_wsa5(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
#endif
